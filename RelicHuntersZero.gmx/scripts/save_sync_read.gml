...
ini_open("saveData.ini");
    ...
    global.allowMouseWheel = ini_read_real('Input','Allow Mouse Wheel',false);
    global.screenShakeRatio = ini_read_real('Quality','screenshake',1.0);
    global.vibrationRatio = ini_read_real('Quality','controller vibration',0.0);
    ...
    global.max_particles = ini_read_real('Quality','max particles',0);
    global.max_casings = ini_read_real('Quality','max casings',0);
